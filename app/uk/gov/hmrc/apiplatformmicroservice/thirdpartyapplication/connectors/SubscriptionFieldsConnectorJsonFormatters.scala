...
// TODO - check this is in the right place
  ...
  implicit val AllApiFieldDefinitionsReads = Json.reads[AllApiFieldDefinitions]
}

trait AccessRequirementsFormatters {
  import uk.gov.hmrc.apiplatformmicroservice.thirdpartyapplication.domain.models.subscriptions.AccessRequirements
  import uk.gov.hmrc.apiplatformmicroservice.thirdpartyapplication.domain.models.subscriptions.{DevhubAccessRequirement, DevhubAccessRequirements}
  import uk.gov.hmrc.apiplatformmicroservice.thirdpartyapplication.domain.models.subscriptions.DevhubAccessRequirement._
