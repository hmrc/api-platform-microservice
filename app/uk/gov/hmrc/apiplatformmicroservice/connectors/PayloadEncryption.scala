...
case class PayloadEncryptionConfig(jsonEncryptionKey: String)

class LocalCrypto @Inject()(payloadEncryptionConfig: PayloadEncryptionConfig) extends CompositeSymmetricCrypto {
  override protected val currentCrypto: Encrypter with Decrypter = new AesCrypto {
    override protected val encryptionKey: String = payloadEncryptionConfig.jsonEncryptionKey
  }
