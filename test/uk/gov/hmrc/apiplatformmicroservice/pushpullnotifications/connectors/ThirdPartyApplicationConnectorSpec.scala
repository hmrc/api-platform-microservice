...
class PushPullNotificationsConnectorSpec extends AsyncHmrcSpec {
  ...
  class Setup(proxyEnabled: Boolean = false) {
    ...
    val connector = new AbstractPushPullNotificationsConnector {
  ...
  class SubordinateSetup(proxyEnabled: Boolean = false) extends Setup(proxyEnabled) {
    ...
    override val connector = new SubordinatePushPullNotificationsConnector(
      config,
      mockHttpClient,
